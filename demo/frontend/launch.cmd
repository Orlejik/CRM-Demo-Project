...
if %ERRORLEVEL%==0 (
    ...
    cd /d C:\Users\artiom.oriol\Documents\JavaProj\demo\temp\Composes || exit /b 1
    docker compose up -d || exit /b 1
    call :wait_for_port 3306 || exit /b 1
)

REM ---- MYSQL LOGS ----
cd /d C:\Users\artiom.oriol\Documents\JavaProj\demo\temp\Composes
...
cd /d C:\Users\artiom.oriol\Documents\JavaProj\demo\demo || exit /b 1
...
cd /d C:\Users\artiom.oriol\Documents\JavaProj\demo\demo\frontend || exit /b 1
